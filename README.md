...
|[Queryosity](https://github.com/taehyounpark/queryosity-benchmarks)| C++ | [Queryosity](https://queryosity.readthedocs.io/en/latest/) is a (semi-)structured data analysis library with support for arbitrary data types. |
