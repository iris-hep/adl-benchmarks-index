...
|[queryosity](https://github.com/taehyounpark/queryosity-benchmarks)| C++ | [queryosity](taehyounpark.github.io/queryosity/) is a declarative data analysis interface with support for arbitrary datasets, column data types, and query outputs through user-side implementations. |
